...
class GobangGUI:
    def __init__(self, master, board, player1, player2):
        ...
        if isinstance(self.player2, Player.AIPlayer1) or isinstance(self.player2, Player.AIPlayer2) or isinstance(self.player2, Player.AIPlayer3) or isinstance(self.player2, Player.AIPlayer4):
